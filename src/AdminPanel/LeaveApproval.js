...
// import { Table, Button, Alert, Form, Container, Row, Col, Card } from 'react-bootstrap';
...
//     // Count requests by status for the current filter
//     const totalCount = filteredLeaveRequests.length;
...
//     <Col
//   md={4}
//   className="d-flex justify-content-center align-items-center border p-2 rounded"
//   style={{ backgroundColor: "#f9f9f9", maxWidth: "340px", maxHeight: "80px" }}
// >
//   <div className="text-center" style={{ fontSize: '14px' }}>
//     <strong>
//       {filterStatus === 'all' ? 'Requests' : filterStatus.charAt(0).toUpperCase() + filterStatus.slice(1)}: 
//     </strong>
...
const LeaveApproval = () => {
    ...
    return (
        ...
        <div style={{ display: 'flex', marginTop: '20px' }}>
            ...
            <div style={{ flex: 1, paddingLeft: '200px', paddingRight: '10px' }}>
                <Container style={{ maxWidth: '90%', marginTop: '20px' }}>
                    <div style={{ width: '90%', margin: '0 auto', padding: '20px', border: '1px  #ddd', borderRadius: '8px', transition: 'all 0.3s' }}
                        onMouseEnter={(e) => e.currentTarget.style.border = '1px solidrgb(190, 195, 201)'}
                        onMouseLeave={(e) => e.currentTarget.style.border = '1px solid #ddd'}>
